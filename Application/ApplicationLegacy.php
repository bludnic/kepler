...
class Application extends ContainerBuilder {
  ...
  protected function loadConfig() {
    $this->addDefinitions($this->basePath() . '/config/app.php');
  }
  ...
  protected function autoload() {
    $this->addDefinitions($this->basePath() . '/config/autoload.php');
  }
  ...
  public function build() {
    $instance = parent::build();
    static::setInstance($instance);

    // Load Sidebars
    foreach ($instance->get('sidebars') as $key => $value) {
      $instance->make($value);
    }

    // Load Metaboxes
    foreach ($instance->get('metaboxes') as $key => $value) {
      $instance->make($value);
    }

    // Load Widgets
    foreach ($instance->get('widgets') as $key => $value) {
      $instance->make($value);
    }

    // Load Templates
    $instance->make($instance->get('templates'));
